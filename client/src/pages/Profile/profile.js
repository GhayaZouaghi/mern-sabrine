...
// import back from "../../assests/modern-colorful-watercolor-background_1035-18933.webp";
const Profile = () => {
  ...
  return (
    <div>
      <div>
        ...
        <Card className="" Name="text-center">
      ...
      <div className="container rounded bg-white mt-5 mb-5" style={{backgroundColor:"blue"}}>
        <div className="row">
